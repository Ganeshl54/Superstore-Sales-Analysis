...
-- 15) Show Products whose Total Sales Are Greater Than 
...
-- 16) Find Top 3 Customers By Sales :
...
-- 17) Find Top Product in Each Category By Sales :
...
-- 18) Find Running Total Sales By Month
select date_format(order_date,"%y-%m") as month,
